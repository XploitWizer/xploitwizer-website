...
const Title = () => (
  <Wrapper>
    <Heading heading="Welcome to the new" subheading="XploitWizer Website" content="Works in progress for XploitWizer, We are large enough to be resourceful and small enough to be flexible and a highly adaptable IT company."/>
    <Instagram href="https://www.instagram.com/xploitwizer/" className="icon-instagram" />
    <Email href="mailto:support@xploitwizer.com?Subject=Hello%20again" className="icon-mail2" />
  </Wrapper>
);
